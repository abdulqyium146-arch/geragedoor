...
export const REVIEWS: Review[] = [
  ...
  },
  {
    ...
    name: 'Robert T.',
    rating: 5,
    excerpt: 'I have used this company twice now and both times have been excellent. They answer the phone immediately — a real person! Fast, professional, fair pricing. My garage door works better than it ever did.',
    date: 'February 2024',
  ...
  },
  {
    ...
    name: 'Michael R.',
    rating: 5,
    excerpt: 'Five stars is not enough. This is a local company that actually cares about their customers. Fast response, great work, and they stood behind their work when I had a minor issue a week later — no questions asked.',
    date: 'February 2024',
