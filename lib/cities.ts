...
export const CITIES: City[] = [
  ...
  { slug: 'poinciana', name: 'Poinciana', county: 'Polk/Osceola', lat: 28.1278, lng: -81.4915, population: 65000 },
  ...
  { slug: 'winter-park', name: 'Winter Park', county: 'Orange', lat: 28.5997, lng: -81.3392, population: 30000 },
  { slug: 'winter-garden', name: 'Winter Garden', county: 'Orange', lat: 28.5653, lng: -81.5864, population: 42000 },
  { slug: 'lake-nona', name: 'Lake Nona', county: 'Orange', lat: 28.3764, lng: -81.2006, population: 35000 },
  { slug: 'altamonte-springs', name: 'Altamonte Springs', county: 'Seminole', lat: 28.6614, lng: -81.3656, population: 44000 },
]
...
export function getCitiesByCounty(county: string): City[] {
  return CITIES.filter(c => c.county.includes(county))
}
