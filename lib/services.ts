...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    keywords: [
      ...
      'garage door repairs in my area',
  ...
  },
  {
    ...
    keywords: [
      ...
      'liftmaster garage door opener installers near me',
      'garage door opener repairman',
  ...
  },
  {
    ...
    keywords: [
      ...
      'emergency garage door repair kissimmee',
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Response times vary by location, but we aim to arrive within 1–3 hours for most emergency calls in Central Florida. We always give you an honest ETA when you call, and our fully stocked trucks mean most emergencies are resolved in a single visit.',
      },
      {
        q: 'Is emergency garage door repair more expensive?',
        a: 'No. We charge the same fair prices for emergency calls — there are no hidden emergency surcharges or surprise fees. You always approve the price before any work begins.',
      },
      {
